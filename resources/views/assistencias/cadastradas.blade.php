...
<div class="wrapper wrapper-content animated fadeInRight">
  <table  class="table table-striped table-bordered table-hover issue-tracker dataTables-assistencias" cellspacing="0">
    <thead>
      <tr>
        <th>ID</th>
        <th>Nome</th>
...
$(document).ready( () =>
$('.dataTables-assistencias').DataTable({
  pageLength: 25,
  responsive: true,
  ...
  buttons: [
    ...
    { extend: 'pdf', title: 'Lista Assistencias' },
